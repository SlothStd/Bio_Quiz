...
public class Organizmy extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        randnazvy.add("Beloritka obyčajná");
        randnazvy.add("Kliešť obyčajný");
        randnazvy.add("Komár piskľavý");
        randnazvy.add("Kútnik domový");
        randnazvy.add("Lastovička obyčajná");
        randnazvy.add("Mola šatová");
        randnazvy.add("Mucha domová");
        randnazvy.add("Múčiar obyčajný");
        randnazvy.add("Myš domová");
        randnazvy.add("Osa obyčajná");
        randnazvy.add("Plamienka driemavá");
        randnazvy.add("Potemník skladový");
        randnazvy.add("Potkan Hnedý");
        randnazvy.add("Rus domový");
        randnazvy.add("Šváb obyčajný");
        randnazvy.add("Švehla obyčajná");
        randnazvy.add("Vijačka domová");
        randnazvy.add("Zákožka svrabová");

        randnazvy.add("Orol skalný");
        randnazvy.add("Mravec lesný");
        randnazvy.add("Včela medonosná");
        randnazvy.add("Pijavica lekárska");
        randnazvy.add("Ďateľ veľký");
        randnazvy.add("Medveď hnedý");
        randnazvy.add("Vlk dravý");
        randnazvy.add("Kobylka lúčna");
        randnazvy.add("Veľryba biela");
        randnazvy.add("Bzdocha obyčajná");
        randnazvy.add("Sova lesná");
        randnazvy.add("Kôň domáci");
        randnazvy.add("Brokolica");
        randnazvy.add("Ropucha obrovská");
        randnazvy.add("Mlok bodkovaný");
        randnazvy.add("Medúza ušatá");
        randnazvy.add("Dážďovka");
        randnazvy.add("Mrkva obyčajná");
